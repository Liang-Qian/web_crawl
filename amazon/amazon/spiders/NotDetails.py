...
from amazon.items import NotdetailsItem
...
class NotdetailsSpider(RedisSpider):
    name = 'NotDetails'
    redis_key = 'NotDetails:start_urls'
    ...
    def parse(self, response):
        ...
        # ASIN
        if 'mediaAsin' in parentAsin_xpath:
            try:
